...
public class AuthController {
    ...
    public ResponseEntity<Void> verifyPassword(@RequestBody Map<String, String> body) {
        userService.verifyPassword(body.get("password"));
    ...
    @PutMapping("/user")
    public ResponseEntity<AuthResponseDto> updateUser(@RequestBody UpdateUserRequestDto dto) {
